...
//        ThemeUtils.checkAppCompatTheme(mContext);
        ...
        mView = (SnackbarBaseLayout) inflater.inflate(R.layout.design_layout_snackbarzy, mTargetParent, false);
    ...
    void animateViewIn() {
        if (Build.VERSION.SDK_INT >= 12) {
            ...
            animator.setInterpolator(cn.com.zhiyihealth.lib_snackbar.AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
            ...
            anim.setInterpolator(cn.com.zhiyihealth.lib_snackbar.AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
